...
const appName = computed(() => settingsStore.appSettings.appName || getDefaultAppName('driver'))
...
const signup = async () => {
  ...
  try {
    ...
    showToast(result.message || 'Your account is waiting for admin approval.', {
      type: 'success',
      duration: 4000
    })
...
<template>
  <div class="login-screen login-screen--driver">
    ...
    <div class="login-card">
      ...
      <p class="login-subtitle">Create your driver account and wait for admin approval before signing in</p>
