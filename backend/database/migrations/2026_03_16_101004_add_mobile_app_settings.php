...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $settings = [
            ...
            ['key' => 'student_app_name', 'value' => 'BUBT Tracker', 'type' => 'text', 'group' => 'student_app', 'description' => 'Student app name displayed on splash screen and headers'],
            ...
            // Driver App Settings
            ['key' => 'driver_app_name', 'value' => 'BUBT Driver', 'type' => 'text', 'group' => 'driver_app', 'description' => 'Driver app name displayed on splash screen and headers'],
