...
<body class="min-h-screen bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 flex items-center justify-center p-4">
    ...
    <div class="relative z-10 w-full max-w-5xl">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="mb-8">
                            <div class="inline-flex items-center justify-center w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl mb-6 animate-float">
                                <i class="bi bi-bus-front-fill text-4xl"></i>
                            </div>
                            <h1 class="text-4xl md:text-5xl font-bold mb-3">Bus Tracker</h1>
                            <p class="text-emerald-100 text-lg">Real-time Bus Tracking System</p>
                        </div>
                        ...
                        <div class="space-y-4 mt-10">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium">Live Tracking</p>
                                    <p class="text-sm text-emerald-100">Track buses in real-time</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-emerald-100">Automated trip scheduling</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-emerald-100">Comprehensive reports</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <p class="text-center text-white/80 text-sm mt-8">
            © 2025 Bus Tracker System. All rights reserved.
        </p>
    </div>
</body>
</html>
